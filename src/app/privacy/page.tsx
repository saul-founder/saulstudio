      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-6 md:px-10 lg:px-4 mx-auto max-w-screen-lg lg:py-16 lg:px-6">
          <div className="format dark:format-invert max-w-none">
            ...
            <p><strong>Verarbeitungszweck:</strong> Ausspielen unserer Internetseiten, Gewährleistung des Betriebs unserer Internetseiten, Verbesserung unseres Internetangebotes, Kommunikation und Marketing</p>
            ...
            <p><strong>Von uns beauftragter Webhoster:</strong></p>
            <p><strong>Vercel</strong><br />Dienstanbieter: Vercel Inc.<br />Internetseite: <a href="https://vercel.com" target="_blank" rel="noreferrer">vercel.com</a><br />Datenschutzerklärung: <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noreferrer">vercel.com/legal/privacy-policy</a></p>
            ...
            <p><strong>Rechtsgrundlage:</strong> Berechtigtes Interesse, Art. 6 Abs. 1 lit. f DSGVO</p>
            <p><strong>Eingesetzte CDN-Dienstleister:</strong></p>
            ...
            <p><strong>Bing Ads</strong><br />Dienstanbieter: Microsoft Corporation, One Microsoft Way, Redmond, WA 98052-6399, USA<br />Sitz in Deutschland: Microsoft Deutschland GmbH, Walter-Gropius-Straße 5, 80807 München<br />Internetseite: <a href="https://ads.microsoft.com/" target="_blank" rel="noreferrer">https://ads.microsoft.com/</a><br />Datenschutzerklärung: <a href="https://privacy.microsoft.com/de-de/privacystatement" target="_blank" rel="noreferrer">https://privacy.microsoft.com/de-de/privacystatement</a></p>
            <p><strong>Google Ads</strong><br />Dienstanbieter: Google Inc., 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA<br />Sitz in Europa: Google Dublin, Google Ireland Ltd., Gordon House, Barrow Street, Dublin 4, Irland<br />Internetseite: <a href="https://ads.google.com/home/" target="_blank" rel="noreferrer">https://ads.google.com/home/</a><br />Datenschutzerklärung: <a href="https://www.google.de/intl/de/policies/privacy" target="_blank" rel="noreferrer">http://www.google.de/intl/de/policies/privacy</a></p>
            ...
            <h3>Auswertung des Nutzerverhaltens</h3>
            ...
            <p><strong>Zweck:</strong> Wir werten den Newsletter wie vorbeschrieben aus, um eine statistische Auswertung des Erfolges oder Misserfolges unseres Newsletters messen zu können.</p>
            <p><strong>Rechtsgrundlage:</strong> Rechtsgrundlage für die Verarbeitung Ihrer Daten ist Art. 6 Abs. 1 lit. a DSGVO.</p>
            <p><strong>Verhinderung:</strong> Sie können Ihre Einwilligung in den Empfang des Newsletters jederzeit über die oben angegebenen Möglichkeiten widerrufen.</p>
            <p><strong>Löschung:</strong> Wir löschen Ihre Daten nach erfolgtem Widerruf.</p>
            ...
            <ul>
              ...
              <li>per E-Mail an: <a href="mailto:newsletter@saulstudio.app">newsletter@saulstudio.app</a></li>
              <li>durch die im Impressum unserer Internetseite vorgehaltenen Kontaktdaten</li>
            </ul>

            <p><strong>Crisp IM SAS</strong><br />Dienstanbieter: 2 Boulevard de Launay, 44100 Nantes, Frankreich<br />Internetseite: <a href="https://crisp.chat" target="_blank" rel="noreferrer">crisp.chat</a><br />Datenschutzerklärung: <a href="https://crisp.chat/en/privacy/" target="_blank" rel="noreferrer">crisp.chat/en/privacy</a></p>
            ...
            <p><strong>Verarbeitungszweck:</strong> Kommunikation und Marketing, Verfolgen und Analyse von Nutzerverhalten</p>
            ...
            <p><strong>Instagram</strong><br />Dienstanbieter: Instagram Inc., 1601 Willow Road, Menlo Park CA 94025, USA<br />Mutterunternehmen: Facebook Inc., 1 Hacker Way, Menlo Park, CA 94025, USA<br />Sitz in der EU: Facebook Ireland Limited, 4 Grand Canal Square, Dublin 2, Ireland<br />Internetseite: <a href="https://www.instagram.com/" target="_blank" rel="noreferrer">https://www.instagram.com/</a><br />Datenschutzerklärung: <a href="http://instagram.com/about/legal/privacy" target="_blank" rel="noreferrer">http://instagram.com/about/legal/privacy</a></p>

            <p><strong>LinkedIn</strong><br />Dienstanbieter: LinkedIn Corporation, 1000 W Maude, Sunnyvale, CA 94085, USA<br />Sitz in Deutschland: LinkedIn, Hofstatt 4th Floor, Sendlinger Str. 12, 80331 München<br />Internetseite: <a href="https://www.linkedin.com/" target="_blank" rel="noreferrer">https://www.linkedin.com/</a><br />Datenschutzerklärung: <a href="https://www.linkedin.com/legal/privacy-policy" target="_blank" rel="noreferrer">https://www.linkedin.com/legal/privacy-policy</a></p>

            <p><strong>Reddit</strong><br />Dienstanbieter: Reddit Inc., 520 3rd Street, San Francisco, CA 94107, USA<br />Sitz in der EU: Reddit Ireland Limited, 70 Sir John Rogerson&apos;s Quay, Dublin 2, Irland<br />Internetseite: <a href="https://www.redditinc.com/" target="_blank" rel="noreferrer">https://www.redditinc.com/</a><br />Datenschutzerklärung: <a href="https://www.redditinc.com/policies/privacy-policy" target="_blank" rel="noreferrer">https://www.redditinc.com/policies/privacy-policy</a></p>

            <h2>Chat-Dienste</h2>
            <p>Wir kommunizieren über Online-Chats und/oder Chatbots (nachfolgend als Chat-Dienste bezeichnet). Unter einem Online-Chat versteht man den Austausch von Text-Nachrichten über das Internet in Echtzeit. Chat-Bots sind Computer-Programme, die in der Regel auf Internetseiten eingesetzt werden, um Nutzerfragen automatisiert zu beantworten oder Benachrichtigungen an Nutzer auszuspielen.</p>
            <p>Sofern Sie unsere Chat-Dienste nutzen, erheben wir Ihre Zugriffs-Daten. Hierzu gehören insbesondere die IP-Adresse des anfragenden Geräts, das Datum und die Uhrzeit der Anfrage sowie Ihre Identifikationsnummer. Ferner speichern wir den Inhalt der über die Chat-Dienste geführte Kommunikation. Schließlich protokollieren wir Ihre Registrierung und Ihre Einwilligungserklärung. Diese Daten nutzen wir, um mit Ihnen über unsere Chat-Dienste kommunizieren zu können, Sie persönlich anzusprechen, um Ihre Anfragen zu beantworten sowie etwaige angeforderte Inhalte zu übermitteln.</p>
            <p>Der oder die unten genannte/n Diensteanbieter hat/haben die Möglichkeit, auf die Metadaten der Kommunikation zuzugreifen. Hierzu gehören Zeit und (je nach Einstellung) Ort der Kommunikation sowie das von Ihnen verwendete Gerät sowie die Information wer mit wem kommuniziert hat. Der Zugriff auf die Metadaten durch den Diensteanbieter erfolgt in der Regel um den Dienst zu optimieren oder aus Sicherheitsgründen. Daneben kann der Zugriff durch den Diensteanbieter aber auch erfolgen, um die Daten zu Marketingzwecken einzusetzen. Näheres hierzu erfahren Sie in der Datenschutzerklärung des Diensteanbieters, die wir nachfolgend verlinkt haben.</p>
            <p>Wir möchten Sie darauf hinweisen, dass je nach Sitzland des unten genannten Anbieters die über dessen Plattform erfassten Daten außerhalb des Raumes der Europäischen Union übertragen und verarbeitet werden können. Es besteht in diesem Fall das Risiko, dass das von der DSGVO vorgeschriebene Datenschutzniveau nicht eingehalten und die Durchsetzung Ihrer Rechte nicht oder nur erschwert erfolgen kann.</p>
            <p><strong>Betroffene Daten:</strong></p>
            <ul>
              <li>Bestands- und Kontaktdaten (bspw. Name, Telefonnummer, E-Mail-Adresse)</li>
              <li>Inhaltsdaten (bspw. Texteingaben)</li>
              <li>Nutzungsdaten (bspw. Zugriffszeiten, Interesse an Inhalten)</li>
              <li>Kommunikationsdaten (bspw. Informationen über das genutzte Gerät, IP-Adresse).</li>
            </ul>
            <p><strong>Verarbeitungszweck:</strong> Kommunikation und Marketing</p>
            <p><strong>Rechtsgrundlage:</strong> Sofern wir Sie vor dem Einsatz des jeweiligen Chat-Dienstes um Ihre Einwilligung gebeten haben, liegt hierin die Rechtsgrundlage, Art. 6 Abs. 1 lit. a DSGVO. Insofern stellen wir klar, dass wir die Ihre Kontaktdaten ohne Ihre Einwilligung nicht erstmalig an den Diensteanbieter übermitteln. Sofern wir mit Ihnen im Rahmen einer Vertragsanbahnung oder im Rahmen eines bestehenden vertraglichen Verhältnisses über einen der nachfolgenden genannten Dienste kommunizieren, besteht die Rechtsgrundlage in der Erfüllung oder Vorbereitung des Vertrages, Art. 6 Abs. 1 lit. b DSGVO. Im Übrigen berufen wir uns auf unsere berechtigten Interessen an einer schnellen und effizienten Kommunikation und Erfüllung der Bedürfnisse unser Kommunikationspartner an der Kommunikation der nachfolgend genannten Dienste, Art. 6 Abs. 1 lit. f DSGVO.</p>
            <p><strong>Widerspruchsmöglichkeiten:</strong> Die uns zur Nutzung des nachfolgenden genannten Dienstes erteilte Einwilligung können Sie jederzeit widerrufen. Der Verarbeitung Ihrer Daten über die von uns genutzten Chat-Dienst können Sie zudem jederzeit widersprechen.</p>
            <p><strong>Wir nutzen folgende Chatbots und Chatfunktionen:</strong></p>
            ...
            <p>Diese Datenschutzerklärung ist aktuell gültig und hat den Stand April 2026. Aufgrund geänderter gesetzlicher bzw. behördlicher Vorgaben kann es notwendig werden, diese Datenschutzerklärung anzupassen.</p>
