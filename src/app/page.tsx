    ...
    <>
        ...
        >
          <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between px-4 py-3 lg:px-6">
            ...
            <div className="flex items-center gap-2 lg:order-2">
              ...
              <button type="button" data-dropdown-toggle="language-dropdown-menu" className="flex items-center text-gray-700 dark:text-gray-300 bg-transparent box-border border border-transparent hover:bg-gray-100 dark:hover:bg-gray-800 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 font-medium leading-5 rounded-lg text-sm p-2.5 focus:outline-none">
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">We build enterprise-grade software for the Shopify ecosystem.</h1>
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="max-w-screen-xl px-4 py-8 mx-auto sm:py-16 lg:py-24">
          <div className="items-center gap-16 lg:grid lg:grid-cols-2">
            ...
            <div className="mt-4 text-gray-500 sm:text-lg lg:mt-0 dark:text-gray-400">
              <p className="mb-4">
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="max-w-screen-xl px-4 pb-8 mx-auto sm:pb-16 lg:pb-24">
          <div className="gap-4 sm:grid sm:grid-cols-4">
            <img className="col-span-2 mb-4 rounded-lg sm:mb-0"
              src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/content/content-gallery-1.png"
              alt="content gallery 1" />
            <img className="hidden col-span-1 rounded-lg sm:block"
            ...
            <img className="col-span-2 rounded-lg"
        ...
        <div className="max-w-screen-xl px-4 pb-8 mx-auto sm:pb-16 lg:pb-24">
          <dl className="grid max-w-screen-md gap-8 mx-auto text-gray-900 sm:grid-cols-3 dark:text-white">
            <div className="flex flex-col items-center justify-center">
              <dt className="mb-2 text-3xl font-extrabold sm:text-4xl">73M+</dt>
              <dd className="text-gray-500 dark:text-gray-400">developers</dd>
            </div>
            <div className="flex flex-col items-center justify-center">
              <dt className="mb-2 text-3xl font-extrabold sm:text-4xl">1B+</dt>
              <dd className="text-gray-500 dark:text-gray-400">contributors</dd>
            </div>
            <div className="flex flex-col items-center justify-center">
              <dt className="mb-2 text-3xl font-extrabold sm:text-4xl">4M+</dt>
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="max-w-screen-xl px-4 py-8 mx-auto sm:py-16 lg:py-24">
          <div className="grid gap-8 sm:gap-16 lg:gap-20 md:grid-cols-2">
            <div className="text-gray-500 sm:text-lg dark:text-gray-400">
              <h2 className="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl dark:text-white">Over 300+
                happy
                clients</h2>
              <p className="lg:text-xl">Let's take most of the money we would've spent on paid advertising and paid
            ...
            <div className="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 sm:grid-cols-3 dark:text-gray-400">
              ...
              <a href="#" className="flex items-center justify-center">
                <svg className="h-10 hover:text-gray-900 dark:hover:text-white" viewBox="0 0 41 50" fill="currentColor"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
              ...
              <a href="#" className="flex items-center justify-center">
                <svg className="h-6 hover:text-gray-900 dark:hover:text-white" viewBox="0 0 124 21" fill="currentColor"
                  ...
                  <path fillRule="evenodd" clipRule="evenodd"
                    ...
                    fill="currentColor" />
                  <path fillRule="evenodd" clipRule="evenodd" d="M102.844 0.069519H107.554V20.2025H102.844V0.069519Z"
                    fill="currentColor" />
                  <path fillRule="evenodd" clipRule="evenodd"
              ...
              <a href="#" className="flex items-center justify-center">
                <svg className="h-8 hover:text-gray-900 dark:hover:text-white" viewBox="0 0 123 32" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
              ...
              <a href="#" className="flex items-center justify-center">
                <svg className="h-7 hover:text-gray-900 dark:hover:text-white" viewBox="0 0 83 31" fill="currentColor"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
          ...
          <div className="mt-12 space-y-16">
            <div className="flex flex-col lg:items-center lg:flex-row gap-y-8 sm:gap-y-12 lg:gap-x-16 xl:gap-x-24">
              ...
              <div className="w-full space-y-6 lg:max-w-lg shrink-0 xl:max-w-2xl">
                ...
                <div className="flex items-center gap-2.5">
                  <img data-tooltip-target="tooltip-logo-html5" className="object-contain w-auto h-8"
                  ...
                  <img data-tooltip-target="tooltip-logo-css3" className="object-contain w-auto h-8"
                  ...
                  <img data-tooltip-target="tooltip-logo-javascript" className="object-contain w-auto h-8"
            ...
            <div className="flex flex-col lg:items-center lg:flex-row gap-y-8 sm:gap-y-12 lg:gap-x-16 xl:gap-x-24">
              ...
              <div className="w-full space-y-6 lg:max-w-lg shrink-0 xl:max-w-2xl lg:order-1">
                ...
                <div className="flex items-center gap-2.5">
                  <img data-tooltip-target="tooltip-logo-wordpress" className="object-contain w-auto h-8"
                  ...
                  <img data-tooltip-target="tooltip-logo-woocommerce" className="object-contain w-auto h-8"
            ...
            <div className="flex flex-col lg:items-center lg:flex-row gap-y-8 sm:gap-y-12 lg:gap-x-16 xl:gap-x-24">
              ...
              <div className="w-full space-y-6 lg:max-w-lg shrink-0 xl:max-w-2xl">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <img data-tooltip-target="tooltip-logo-java" className="object-contain w-auto h-8"
                  ...
                  <img data-tooltip-target="tooltip-logo-react" className="object-contain w-auto h-8"
                  ...
                  <img data-tooltip-target="tooltip-logo-amazon-web-services" className="object-contain w-auto h-8"
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="max-w-screen-xl px-4 py-8 mx-auto sm:py-16 lg:py-24">
          ...
          <div className="grid grid-cols-1 mt-12 gap-y-12 gap-x-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
            <div>
              <img className="object-cover object-top w-full h-48 rounded-lg"
                ...
                <ul className="flex items-center gap-3">
                  <li>
                    <a href="#" title="" className="">
                      ...
                      <svg aria-hidden="true" className="w-5 h-5 text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"
          ...
          <div className="max-w-3xl p-4 mx-auto mt-8 rounded-md lg:mt-12 bg-gray-50 dark:bg-gray-800">
            <div className="flex flex-col justify-between gap-3 md:gap-6 md:items-center md:flex-row">
              <div className="flex items-center gap-1.5">
                <svg className="hidden w-5 h-5 text-gray-800 dark:text-gray-400 md:block shrink-0"
              ...
              <a href="#" title=""
                ...
                Join our team
                <svg aria-hidden="true" className="w-4 h-4 ml-1.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                  fill="currentColor">
                  <path fillRule="evenodd"
